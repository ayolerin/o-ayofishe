        ...
        ?>
            ...
            <div class="modal-body">
                        <div class=form-group">
                            <label> Please Type Review Below </label>
                            <input type="text" name="comments" class="form-control" placeholder="Type Review">
                        </div>
                    </div>

                    <!-- </div> -->
                    <div class="btn-block">
                    <a class="btn3 flex-c-m size13 txt11 trans-0-4 m-l-r-auto">
                        <button type="submit" name="review">Send Review</button>
                    </a>
                    </div>
                    <div class="btn-block">
